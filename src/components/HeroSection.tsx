      ...
      <div className="sticky top-0 h-screen bg-white" style={{ overflow: 'visible' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center w-full">
            ...
            {/* ── Gauche ── */}
            {/* overflow:hidden pour masquer le panel entrant/sortant, hauteur fixe suffisante */}
            <div className="relative overflow-hidden" style={{ height: '520px' }}>
              ...
              >
                ...
                <p className="text-gray-500 text-sm mb-5">
                  Des solutions pour l&apos;habitat collectif et le tertiaire.
                </p>

                {/* Carrousel vertical — survol pour déplier */}
